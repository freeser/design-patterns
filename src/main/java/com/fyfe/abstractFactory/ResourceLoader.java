package com.fyfe.abstractFactory;
...
public class ResourceLoader {
    ...
    public void load(String url) {
        ...
        resourceLoaderCache.get(prefix).loadPictureResource(url);
        resourceLoaderCache.get(prefix).loadTextResource(url);
        resourceLoaderCache.get(prefix).loadVideoResource(url);
    }
